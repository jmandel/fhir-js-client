module.exports = function (grunt) {
  ...
  grunt.initConfig({
    shell: {
      browserify: {
        command: "./node_modules/.bin/browserify -e src/adapters/jquery.js    -i 'jsdom' -t varify > dist/fhir-client-jquery.js; " +
                 "./node_modules/.bin/browserify -e src/adapters/angularjs.js -i 'jsdom' -t varify > dist/fhir-client-angularjs.js; " +
                 "./node_modules/.bin/browserify -e src/adapters/bundle.js    -i 'jsdom' -t varify > dist/fhir-client.js",
        options: {
          failOnError: true,
          stderr: true
        }
