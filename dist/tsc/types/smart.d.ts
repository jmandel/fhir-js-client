 ...
 */
export declare function completeAuth(env: BaseAdapter): Promise<Client>;
/**
 ...
 * @param [onError]
 */
export declare function ready(env: BaseAdapter, onSuccess?: () => any, onError?: () => any): Promise<Client>;
export declare function init(env: BaseAdapter, options: fhirclient.AuthorizeParams): Promise<Client | never>;
