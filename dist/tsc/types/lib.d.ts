...
export declare const getAndCache: (url: string, force?: boolean | undefined) => Promise<any>;
...
interface ObservationMap {
    [code: string]: fhirclient.FHIR.Observation[];
}
/**
 ...
 */
export declare function byCode(observations: fhirclient.FHIR.Observation | fhirclient.FHIR.Observation[], property: string): ObservationMap;
/**
...
export declare function ensureNumerical({ value, code }: CodeValue): void;
