...
var _ref = global.FHIRCLIENT_PURE ? window : __webpack_require__(/*! cross-fetch */ "./node_modules/cross-fetch/dist/browser-ponyfill.js"),
...
exports.default = BrowserAdapter.smart;
...
var _BrowserAdapter_1$def = BrowserAdapter_1.default(),
    ...
    options = _BrowserAdapter_1$def.options;

exports.client = client; // We have two kinds of browser builds - "pure" for new browsers and "legacy"
...
function _authorize() {
  ...
  _regenerator.default.mark(function _callee(env, params, _noRedirect) {
    var _params, redirect_uri, clientSecret, fakeTokenResponse, patientId, encounterId, client_id, _params2, iss, launch, fhirServiceUrl, redirectUri, _params2$scope, scope, clientId, url, storage, serverUrl, stateKey, state, redirectUrl, extensions, redirectParams;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            // Obtain input
            _params = params, redirect_uri = _params.redirect_uri, clientSecret = _params.clientSecret, fakeTokenResponse = _params.fakeTokenResponse, patientId = _params.patientId, encounterId = _params.encounterId, client_id = _params.client_id;
...
function _completeAuth() {
  ...
  _regenerator.default.mark(function _callee2(env) {
    var _a, _b, _c, _d, url, Storage, params, key, code, authError, authErrorDescription, state, fullSessionStorageSupport, hasState, authorized, requestOptions, tokenResponse, client;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 18:
            ...
            fullSessionStorageSupport = lib_1.isBrowser() ? lib_1.getPath(env, "options.fullSessionStorageSupport") : true; // Do we have to remove the `code` and `state` params from the URL?
