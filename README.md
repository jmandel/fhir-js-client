...
> This the documentation for the current version. If you want to migrate from older versions, make sure uou check out [what is new in v2](http://docs.smarthealthit.org/client-js/v2.html).
